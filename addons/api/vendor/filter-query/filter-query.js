...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c15 = "not in",
      peg$c16 = peg$literalExpectation("not in", false),
      ...
      peg$c24 = "\"/item/",
      peg$c25 = peg$literalExpectation("\"/item/", false),
      peg$c26 = /^[^"]/,
      ...
      peg$c31 = function(str) { return str.join(''); },
      peg$c32 = "\t",
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          s4 = peg$parse_();
          if (s4 !== peg$FAILED) {
            s5 = peg$parseItemAttributeReference();
            if (s5 !== peg$FAILED) {
              peg$savedPos = s0;
              s1 = peg$c14(s1, s5);
              s0 = s1;
  ...
  function peg$parseEqualsExpression() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseItemAttributeReference();
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      if (s2 !== peg$FAILED) {
  ...
  function peg$parseItemAttributeReference() {
    var s0, s1, s2, s3;
